...
export function FilterBar({ onChange }: { onChange?: (sel: Record<PlatKey, boolean>) => void }) {
  ...
  return (
    <div style={{
      ...
      padding: '12px 22px', flexWrap: 'wrap',
    }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginLeft: 'auto' }}>
        ...
        <div style={{ height: 40, background: '#F6F4EF', border: '1px solid #E4E1D8', borderRadius: 9, display: 'flex', alignItems: 'center', gap: 10, padding: '0 14px', fontSize: 14, fontWeight: 600, color: '#1C1B19', cursor: 'pointer' }}>
          Más relevantes
