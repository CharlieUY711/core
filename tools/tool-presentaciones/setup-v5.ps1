# CORE Presentaciones — Setup V5
# Mismo encabezado que CORE Market, centrado correcto, sin textos en inglés
# cd C:\CORE\apps\core-presentaciones
# Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass
# .\setup-v5.ps1

$base = Split-Path -Parent $MyInvocation.MyCommand.Path
Write-Host "CORE Presentaciones V5" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "V5 listo. pnpm dev" -ForegroundColor Yellow