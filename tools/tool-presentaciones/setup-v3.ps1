# CORE Presentaciones — Setup V3 (estilos inline, centrado correcto)
# cd C:\CORE\apps\core-presentaciones
# Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass
# .\setup-v3.ps1

$base = Split-Path -Parent $MyInvocation.MyCommand.Path
Write-Host "CORE Presentaciones V3" -ForegroundColor Cyan
...
export function HeroSection() {
  ...
  return (
    <section id="hero" style={{
      ...
      <div style={{
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", marginBottom: "32px" }}>
            <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#c9993a", animation: "pulse 2s infinite" }} />
        ...
        >
          ...
          <p style={{ color: "#4a6080", fontSize: "13px", letterSpacing: "0.08em" }}>
            {t.hero.sub}
          </p>
        </motion.div>
      </div>
      ...
      >
        <span style={{ color: "#4a6080", fontSize: "10px", letterSpacing: "0.15em", textTransform: "uppercase" }}>
          {t.hero.scroll}
        </span>
        <motion.div
...
Write-Host ""
Write-Host "Setup V3 completo. Ejecuta: pnpm dev" -ForegroundColor Yellow