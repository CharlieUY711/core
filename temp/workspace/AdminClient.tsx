  ...
  return (
    <div>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '13px', color: 'var(--color-text-3)' }}>Gestioná paletas, diseños y portales del ecosistema CORE.</p>
      </div>
...
function PortalsSection({ portals, router, onConfig }: {
  portals: Portal[];
  router: ReturnType<typeof useRouter>;
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
        <h2 style={{ fontSize: '16px', fontWeight: 600, color: 'var(--color-text)', margin: 0 }}>Portales</h2>
        <BtnOutline label="+ Nuevo Portal" onClick={() => router.push('/dashboard/admin/portals/new')} />
      </div>
