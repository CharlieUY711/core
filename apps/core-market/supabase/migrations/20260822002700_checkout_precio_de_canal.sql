-- ===========================================================================
-- El checkout cobra el precio del canal
-- ===========================================================================
--
-- Leia v.precio directo, asi que ignoraba el precio propio del canal y cobraba
-- siempre el general. Un precio por canal que la caja no respeta es peor que no
-- tenerlo: alguien lo configura, lo ve guardado, y se cobra otra cosa.
--
-- Pasa a usar precio_de_canal(), la misma funcion que usa la vidriera. Que sea
-- la misma es el punto: dos resoluciones separadas terminan discrepando, y la
-- forma en que se nota es que el sitio muestra un numero y la caja cobra otro.
-- ===========================================================================
...
BEGIN
  ...
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items) LOOP
    ...
    SELECT b.titulo, b.status::text, coalesce(v.stock, 0)
      INTO v_nombre_prod, v_status, v_stock
