...
--
-- ADVERTENCIA: Solo aplicar si no hay migraciones posteriores a 0003.
...
-- ============================================================
-- BLOQUE R1 — Eliminar todas las policies DELETE
-- ============================================================
...
-- ============================================================
-- BLOQUE R2 — Restaurar policies superadmin_* con UUID hardcodeado
--
...
CREATE POLICY superadmin_bom          ON public.bom_lines         FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_compliance   ON public.compliance_matrix FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_documents    ON public.documents         FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_members      ON public.project_members   FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_bypass       ON public.projects          FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_requirements ON public.requirements      FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_rfqs         ON public.rfqs              FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);
CREATE POLICY superadmin_risks        ON public.risks             FOR ALL USING (auth.uid() = '5e12ace0-05c6-4208-b7c8-8250b7063848'::uuid);

DROP FUNCTION IF EXISTS public.is_superadmin();


-- ============================================================
-- BLOQUE R3 — Eliminar columna is_superadmin de profiles
--
-- PRECAUCIÓN: borra el dato de quién es superadmin.
-- El UUID del superadmin actual es: 5e12ace0-05c6-4208-b7c8-8250b7063848
-- ============================================================
...
-- ============================================================
-- BLOQUE R4 — Restaurar project_members.role a enum project_role
-- ============================================================

-- Dropear FK y policy recreada
...
-- Recrear policy original con cast al enum
...
-- ============================================================
-- BLOQUE R5 — Vaciar project_roles
-- Solo elimina los 14 roles insertados por 0003.
-- ============================================================
